...
class SortTask extends AsyncTask
{
    ...
    /**
     * @param string $player
     * @param ThreadSafeArray $moneyData
     * @param bool $addOp
     * @param int $page
     * @param ThreadSafeArray $ops
     * @param ThreadSafeArray $banList
     */
    public function __construct(private string $sender, private ThreadSafeArray $moneyData, private bool $addOp, private int $page, private ThreadSafeArray $ops, private ThreadSafeArray $banList) {}
