...
class TopMoneyCommand extends Command
{
    ...
    public function execute(CommandSender $sender, string $label, array $params): bool
    {
        ...
        $task = new SortTask($sender->getName(), ThreadSafeArray::fromArray($this->plugin->getAllMoney()), $this->plugin->getConfig()->get("add-op-at-rank"), $page, ThreadSafeArray::fromArray($ops), ThreadSafeArray::fromArray($banned));
